...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
        ...
        home: MyHomePage(title: 'Bluetooth seeker'),
      );
}
          ...
          child: Row(
            children: <Widget>[
              Expanded(
                child: Column(
                  children: <Widget>[
                    Text(device.name == '' ? '(Dispositivo desconocido)' : device.name),
              ...
              onPressed: () async {
                await showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        title: const Text("Sobreescribir"),
                        content: Row(
                          children: <Widget>[
                            Expanded(
                              child: TextField(
